...
Rect calculateQrCodeScanWindow(BuildContext context, {Offset offsetFromCenter = Offset.zero}) {
  ...
  return Rect.fromCenter(
    center: screenSize.center(offsetFromCenter),
    width: scanSize,
    height: scanSize,
  );
}
...
Rect calculateBarcodeScanWindow(BuildContext context, {Offset offsetFromCenter = Offset.zero}) {
  final screenSize = MediaQuery.sizeOf(context);
