...
class DraggableScannerSheet extends StatefulWidget {
  final void Function(String barcode) onBarcodeScanned;
  final ScrollController scrollController;
  final int sameItemCooldownMs;

  const DraggableScannerSheet({
    super.key,
  ...
  @override
  State<DraggableScannerSheet> createState() => _DraggableScannerSheetState();
}

class _DraggableScannerSheetState extends State<DraggableScannerSheet> with WidgetsBindingObserver {
